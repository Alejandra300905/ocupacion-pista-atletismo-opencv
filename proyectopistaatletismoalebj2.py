# -*- coding: utf-8 -*-
"""
Sistema de medición de ocupación en pista de atletismo usando OpenCV

Descripción:
Este programa detecta corredores en una pista de atletismo mediante
procesamiento digital de imágenes. Utiliza una imagen de referencia
sin corredores y una imagen de prueba para identificar cambios,
contar personas y calcular el porcentaje de ocupación.
...
RUTA_SALIDA = "resultados/resultado_final.jpg"
